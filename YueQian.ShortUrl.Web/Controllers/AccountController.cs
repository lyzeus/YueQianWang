...
using YueQian.ShortUrl.Web.Filters;
...
namespace YueQian.ShortUrl.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (Request.IsAuthenticated && Roles.IsUserInRole(User.Identity.Name, "Admin"))
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "您的帐号权限不够！");
                return View(model);
            }
        ...
        [AllowAnonymous]
        public ActionResult Register(string yqId = "")
        {
            if (string.Equals(yqId, "yqShortUrl"))
                return View();
            return Content("注册你大爷！");
        }
